...
import { LayoutTemplate, Sparkles, Zap, Moon, Palette } from 'lucide-react';
...
export const WebConfig: React.FC = () => {
  const styles = [
    { id: 'unspecified', label: 'Unspecified', icon: Sparkles },
    { id: 'modern', label: 'Modern', icon: LayoutTemplate },
    { id: 'brutalist', label: 'Brutalist', icon: Zap },
    { id: 'academic', label: 'Academic', icon: Palette },
  ];
          ...
          <section>
            ...
            <div className="grid grid-cols-2 gap-2">
              {styles.map((style) => (
                ...
                >
                  <style.icon className={cn("w-4 h-4", style.id === 'modern' ? "text-brand-blue" : "text-slate-400 group-hover:text-brand-dark")} />
          ...
          <section>
            ...
            <div className="space-y-2">
              <div className="relative">
                <select className="w-full bg-slate-50 border border-slate-200 rounded-lg px-3 py-2.5 text-xs text-brand-dark appearance-none focus:outline-none focus:ring-2 focus:ring-brand-blue/20 focus:border-brand-blue transition-all cursor-pointer">
                  <option>HTML5 + Tailwind CDN</option>
                  <option>React + Babel Standalone</option>
                  <option>Vue 3 + UnoCSS</option>
                </select>
              ...
              <p className="text-[9px] text-slate-400 px-1 leading-normal italic">
                * Selected stack will be executed in your local VFS environment.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-1">
              {[
                ...
                { id: 'anim', label: 'Motion Effects', icon: Zap, default: true },
              ].map((opt) => (
                <label key={opt.id} className="flex items-center justify-between p-3 rounded-xl hover:bg-slate-50 transition-colors cursor-pointer group">
                  ...
                  <input type="checkbox" defaultChecked={opt.default} className="w-4 h-4 rounded border-slate-300 text-brand-blue focus:ring-brand-blue transition-all accent-brand-blue" />
                </label>
              ))}
            </div>
          </section>
